...
switch (menu)
{
    ...
    bool control2=float.TryParse(Console.ReadLine(),out b);  
    ...
    bool control4=float.TryParse(Console.ReadLine(),out b);  
    Console.WriteLine("{0} - {1} = {2}",a,b,a-b);
    ...
    bool control6=float.TryParse(Console.ReadLine(),out b);  
    ...
    bool control8=float.TryParse(Console.ReadLine(),out b);  
    Console.WriteLine("{0} : {1} = {2}",a,b,a/b);
